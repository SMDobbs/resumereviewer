...
import { ArrowLeftIcon, UserGroupIcon, ClockIcon, CalendarIcon, CheckCircleIcon, StarIcon } from '@heroicons/react/24/outline'
    ...
    <div className="min-h-screen bg-gray-950 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass rounded-xl p-8 bg-gradient-to-br from-green-900/20 to-green-800/20 text-center">
          <h3 className="text-2xl font-bold mb-2">Complete Career Transformation Package</h3>
          <p className="text-gray-400 mb-6">Get all three coaching sessions and save 25%</p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
            <div>
              <span className="text-4xl font-bold text-green-400">$240</span>
              <span className="text-gray-500 line-through ml-2">$321</span>
            </div>
            <div className="text-left">
              <p className="text-sm text-gray-400">✓ Mock Interview Session</p>
              <p className="text-sm text-gray-400">✓ Career Strategy Session</p>
              <p className="text-sm text-gray-400">✓ Resume & LinkedIn Review</p>
            </div>
          </div>
          ...
          <p className="text-sm text-gray-500 mt-2">Most clients land roles within 30-60 days</p>
        </div>
      </div>
    </div>
  )
